...
Type conversion is similar to type coercion because they both convert values from 
one data type to another with one key difference — type coercion is implicit whereas 
type conversion can be either implicit or explicit.

? Examples of truthy values in JavaScript  will be coerced to true in boolean contexts, 
? and thus can execute if blocks, for example.
*/
