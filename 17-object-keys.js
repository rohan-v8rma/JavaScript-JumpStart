...
* 1. Introduction to keys
? A JavaScript object is a collection of unordered keys and properties. Properties can usually be changed, added, and deleted, but some are read only.
...
/*
Both these properties can only be accessed using bracket notation since these aren't valid identifier names. The first property is a numeric literal, so we can use proper scientific notation when accessing that property.
*/
...
Here the object 'Object' has a method called keys() which takes another object as an argument whose keys/'property names' have to be told.
*/
console.log(keys)
/*
We can consider keys to be names of the properties of an object, they specify what a particular property of an object encompasses.
*/