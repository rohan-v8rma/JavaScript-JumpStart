...
"hello.__proto__ === Object.prototype" will return 'true', since the prototype inherited
by 'hello' is the same prototype which 'Object' passes on to instances of itself.

* "Object.__proto__" will return 'undefined' since the global Object class doesn't inherit
...
! NOTE : '[[prototype]]', which is an "internal property" of an object, (indicated by the fact that it is 
...
/* 
'Prototype' itself is an object, so the prototype of 'Prototype' is Object.prototype
which it inherits from global Object class. 
